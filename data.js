...
const SITE = {
  ...
  /* ---------- About Me 简介（支持多段） ---------- */
  bio: [
    "I am a Master's student at the School of Informatics, Xiamen University, majoring in Computer Science and Technology. My research interests include LLM agents, knowledge distillation, hypergraphs, knowledge graphs, and bioinformatics.",
  ...
  publications: [
    {
      ...
      image: "",                                   // 可填 framework 缩略图，如 "pic/HKD-CPI_framework.png"
      imageFull: "",                               // 点击缩略图放大查看，可填 PDF 矢量图
